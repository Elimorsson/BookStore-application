...
public abstract class MicroService implements Runnable {
    ...
    protected HashMap <Class,Callback> messageVsCallbackMap;
    ...
    public MicroService(String name) {
        this.name = name;
        messageVsCallbackMap = new HashMap<>();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        messageVsCallbackMap.put(type,callback);
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                Callback c = messageVsCallbackMap.get(message.getClass());
                c.call(message);
